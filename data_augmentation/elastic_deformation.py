...
class ElasticDeformation(object):
    ...
    def __init__(self, grid_size=3, displacement=10) -> None:
    ...
    def __call__(self, image):
        ...
        displaced_points = source_points + np.random.uniform(-self._displacement, self._displacement, source_points.shape)
...
if __name__ == '__main__':
    ...
    sample = dataset[1]
    print(type(sample['image_anno']))
    plt.figure()
    plt.imshow(ElasticDeformation(grid_size=3, displacement=15)(sample['image_anno']))
    plt.figure()
